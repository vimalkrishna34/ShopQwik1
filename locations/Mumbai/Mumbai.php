...
<div class="container py-5">
    ...
    <div class="mall-selector" style="margin-top: 70px;">
        <select id="mallSelect" class="form-select" onchange="goToSlide(this.value)">
            ...
            <?php
            $malls = [
                ["name" => "Phoenix Marketcity", "image" => "https://www.phoenixoffices.in/wp-content/uploads/2015/12/DeathtoStock_Holiday2-1-1170x530.jpg", 'link' => '/PROJECTT/anj/ShopQwik-main/ShopQwik/locations/Mumbai/Pheonix.php', 'description' => 'Mumbai\'s largest mall with luxury shopping, entertainment, and dining options.', 'features' => ['Luxury', 'Entertainment', 'Dining']],
                ["name" => "High Street Phoenix", "image" => "https://www.hindustantimes.com/ht-img/img/2024/08/31/550x309/Mumbai--India--Aug-31--2024--Phoenix-Mill-compound_1725131803346.jpg", 'link' => '/PROJECTT/anj/ShopQwik-main/ShopQwik/locations/Mumbai/Highstreet.php', 'description' => 'Premium shopping destination with international brands and fine dining.', 'features' => ['International Brands', 'Fine Dining']],
                ...
                ["name" => "Infiniti Mall", "image" => "https://files.lbb.in/media/2019/12/5e05fd7da99fe673cd1d7792_1577450877774.jpg", 'link' => '/PROJECTT/anj/ShopQwik-main/ShopQwik/locations/Mumbai/Infinity.php', 'description' => 'Great mix of brands, entertainment, and dining options for all ages.', 'features' => ['Fashion', 'Entertainment', 'Dining']],
                ...
                ["name" => "Nexus seawoods", "image" => "https://media.assettype.com/freepressjournal/2025-01-22/omzd0o3d/FotoJet-40.jpg?width=1200", 'link' => '/PROJECTT/anj/ShopQwik-main/ShopQwik/locations/Mumbai/nexus.php', 'description' => 'Modern mall with premium and local stores, plus entertainment options.', 'features' => ['Modern', 'Local Stores', 'Entertainment']]
            ];
