...
<head>
    ...
    <title>Sarath City Mall Hyderabad - ShopQwik</title>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        :root {
            --primary-color: #FF6B6B; /* Sarath City vibrant color */
            --secondary-color: #4ECDC4; /* Complementary teal */
            --light-bg: #F7FFF7;
            --dark-text: #292F36;
            --light-text: #6B778D;
        }
        ...
        .brand-card:hover {
            ...
            box-shadow: 0 15px 25px rgba(255, 107, 107, 0.1);
        }
        .brand-img-container {
...
<body>
    <div class="container">
        ...
        <div class="mall-banner">
            ...
            <div>
                <h2 style="margin: 0; color: white;">Sarath City Mall</h2>
                <p style="margin: 5px 0 0; opacity: 0.9;">India's largest mall in Hyderabad</p>
                <div style="margin-top: 10px;">
                    <span class="feature-badge"><i class="fas fa-star"></i> Premium</span>
                    <span class="feature-badge"><i class="fas fa-utensils"></i> Dining</span>
                    <span class="feature-badge"><i class="fas fa-film"></i> Entertainment</span>
                </div>
            </div>
        </div>
        
        <h1 class="mall-title">Featured Brands</h1>
