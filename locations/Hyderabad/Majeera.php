...
<head>
    ...
    <title>Manjeera Mall Hyderabad - ShopQwik</title>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        :root {
            --primary-color: #E84C3D; /* Manjeera red */
            --secondary-color: #2D3E50; /* Manjeera dark blue */
            --light-bg: #F5F7FA;
            --dark-text: #333333;
            --light-text: #666666;
        }
        ...
        .brand-card:hover {
            ...
            box-shadow: 0 15px 25px rgba(232, 76, 61, 0.1);
        }
        .brand-img-container {
...
<body>
    <div class="container">
        ...
        <div class="mall-banner">
            ...
            <div>
                <h2 style="margin: 0; color: white;">Manjeera Mall Hyderabad</h2>
                <p style="margin: 5px 0 0; opacity: 0.9;">Your premier shopping destination in Hyderabad</p>
            </div>
        </div>
