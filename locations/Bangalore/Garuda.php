...
<head>
    ...
    <title>Garuda Mall Brands</title>
    ...
    <style>
        body {
            ...
            margin: 50px;
            padding-top: 60px; /* Added padding to prevent content from being hidden under fixed back button */
        }
        .card-img-top {
            height: 250px;
            width: 100%;
...
<body>
    ...
    <div class="container">
        <h1>Top Brands in Garuda Mall Bangalore</h1>
